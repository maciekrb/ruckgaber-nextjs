        ...
        <Box my={4}>
          ...
          <Box my={4}>
            <Grid container spacing={4} alignItems="center">
              <Grid item md={7}>
                <Typography variant="h6" gutterBottom>Ancestry</Typography>
                <Typography paragraph>In the early 1830s, Jan Ruckgaber and F.X. Mozart56 set up the Society of Friends of Music (Gesellschaft der Musikfreunde)8, which soon became a foundation for the Galician Music Society, officially registered on the 14th of August 1838.</Typography>
                <Typography paragraph>Later in the same year Franz Xavier Mozart left for Vienna, and Jan Ruckgaber replaced him in the organisational work. In the years 1838-42, the Society worked under his direction as an art manager. Ruckgaber was also the conductor of the orchestra and choirs and later the manager of a music school. </Typography>
              ...
              <Grid item md={5} sm={6}>
                <Card>
                  <CardMedia
                    ...
                    title="Franciszek Ksawery Wolfgang Mozart, son (http://zaxid.net/news/, 2015)"/>
                  <CardContent>
                    <Typography variant="caption">Franciszek Ksawery Wolfgang Mozart, son (http://zaxid.net/news/, 2015)</Typography>
                  </CardContent>
                </Card>
              </Grid>

              <Grid item sm={7}>
                <Typography paragraph>The period of best prosperity for the Galician Music Society came in the years 1842-48. At that time the society held numerous concerts, charity events and musical meetings. Ruckgaber invited the most eminent musicians in Europe to perform in Lviv. The public was most impressed by violinist Bedřich Smetana (1843), pianist Libra Ottawa (1844), violinist Heinrich Ernst (1845), cellist Marek Bauer (1843) and pianist Leopold Mayer (1843), but it was Ferenc Liszt who performing for the whole month at the turn of April and May, 1847, broke records of popularity. </Typography>
              ...
              <Grid item sm={12}>
                ...
                <Typography paragraph>The music school at the society was reopened on the 1st of May 1854, this time as a Conservtoire. It was one of the oldest in Europe, older than the conservatoires in Petersburg (eatablished in 1862) and in Moscow (1864).</Typography>
                <Typography paragraph>At first it was led by the director Jan Ruckgaber. Art of composition was taught along with theoretical subjects, as harmonics, counterpoint, instrumentation and analysis of music forms. From the first years of the Galician Music Society, Ruckgaber gathered repertoire for a music library, whose collection  was even enriched when the conservatoire was established. </Typography>
