      ...
      <Container maxWidth="md">
        <Box my={4}>
          ...
          <Box my={4}>
            ...
            <Typography paragraph>'Pasó la mayor parte de su vida en Lviv, un bullicioso pueblo polaco con cultura polaco, He spent most of his lifetime in Lviv, a Polish town bustling with Polish culture, although Poland did not then exist on the map of Europe.</Typography>
